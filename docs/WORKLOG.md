...
- Added backend version marker `sql-postman-customer-20260723` to SQL connection tests and direct create errors so Chloe can confirm whether the deployed Apps Script Web App is running the latest backend.
